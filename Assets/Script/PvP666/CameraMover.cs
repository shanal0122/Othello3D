...
namespace PvP666
{
  public class CameraMover : MonoBehaviour
  {
      ...
      void Start()
      {
          float xCenterCoordi =2.5f;
          float yCenterCoordi =2.5f;
          float zCenterCoordi =2.5f;
          center = new Vector3(xCenterCoordi,yCenterCoordi,zCenterCoordi); //中心位置の定義

          mainCameraTransform = this.gameObject.transform;
          mainCameraTransform.position = new Vector3 (xCenterCoordi, yCenterCoordi, zCenterCoordi - 12f);
